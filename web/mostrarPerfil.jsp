    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-portifolio">
        ...
        <div>
         ...
         <div class="container-fluid tabela">
             ...
             <fieldset>
               <legend> CONTROLE DE PERFIL </legend>
                <table id="tabela-dados2">
            <tr>
                <th>ID - Atualizar</th>
                <th>Nome</th>
                <th>Gerenciar Perfil</th>
                <th>Excluir Perfil</th>
            </tr>

         <c:forEach var="lista" items="${ requestScope.perfilList }">
            <tr>
                <td>
                    <a href="ClienteServlet?cmd=atu&id=${lista.id}">
                        ${lista.id}
                    </a>
                </td>
                <td>${lista.perfil}</td>
                <td>
                    <a href="PerfilServlet?cmd=gerenciar&id=${lista.id}">
                        Gerenciar
                    </a>
                </td>
                <td>
                    <a href="ClienteServlet?cmd=exc&id=${lista.id}">
                        Excluir
                    </a>
                </td>
            </tr>
