...
<%@page import="modelo.AgendamentoDAO"%>
...
<html>
   ...
   <body id="page-top">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-portifolio">
        ...
        <c:forEach var="lista" items="${ requestScope.agendamentoList }">
            <tr>
                <td>
                    <a href="AgendamentoServlet?cmd=atu&id=${lista.id}">
                        ${lista.id}
                    </a>
                </td>
                <td><fmt:formatDate pattern="dd/MM/yyyy" value="${lista.data}"></fmt:formatDate></td>
                <td>${lista.hora}</td>
                <td>${lista.observacao}</td>
                
                <td>
                    <a href="AgendamentoServlet?cmd=exc&id=${lista.id}">
                        Excluir
                    </a>
                </td>
            </tr>
