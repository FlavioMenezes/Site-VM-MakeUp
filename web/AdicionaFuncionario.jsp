        ...
        <div>
         ...
         <div class="container-fluid tabela">
             <table id="tabela-dados">
                ...
                <td>
                        <form name="form_usuario" action="FuncionarioServlet?cmd=cadastrar" method="post" onsubmit="return validaForm();">
                             <fieldset>
                                <legend> Dados de Login </legend>
                                    <label for="login"> Login <input id="login" type="text" name="login" size="80px"></label>
                                    <label for="senha"> Senha <input id="senha" type="password" name="senha" size="80px"></label>
                            </fieldset>
                            <fieldset>
