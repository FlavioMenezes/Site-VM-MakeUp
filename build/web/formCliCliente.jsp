             ...
             <table id="tabela-dados">
                ...
                <tr>
                    <td>
                                ...
                                <jsp:useBean id="usuarioA" scope="session"
                     class="modelo.Usuario" />

                                <h1> Atualizar </h1>
                                
        <form action="ClienteServlet?cmd=atualizar" method="post">
            <table id="tabela-dados2">
                <tr>
                    <td>ID:</td>
                    <td>
                        <input type="text" name="id"
                               value="${usuarioAtu.id}" readonly="readonly" />
                    </td>
                </tr>
                ...
                <tr>
                    <td>Login:</td>
                    <td>
                        <input type="text" name="login" value="${usuarioAtu.login}" />
                    </td>
                </tr>
                <tr>
                    <td>Senha:</td>
                    <td>
                        <input type="password" name="senha" value="${usuarioAtu.senha}" />
                    </td>
                </tr>
                <tr>
                    <td>Perfil:</td>
                    <td>
                        <select name="id_perfil">
                            <option> ${usuarioAtu.perfil.perfil}</option>
                            <%
